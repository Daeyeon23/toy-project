...
const CAUSES: Cause[] = [
  ...
  },
  {
    ...
    action: "라이 사용 시 3~4%(중량 기준) 농도를 지키고, 베이킹소다로 대체할 경우 그 한계(진한 마호가니색은 못 낸다는 점)를 감안하세요. 식용 라이(수산화나트륨)는 피부·눈에 화상을 입힐 수 있는 부식성 물질이니, 반드시 내열 장갑과 보안경을 착용하고 찬물에 라이를 천천히 넣으며(반대 순서 금지) 환기가 되는 곳에서 다루고, 알루미늄 용기는 피하세요.",
  },
];
