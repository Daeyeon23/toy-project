...
const CAUSES: Cause[] = [
  ...
  },
  {
    ...
    action: "오븐 발효 기능이나 따뜻한 물 옆 등 26~28℃ 환경에서 발효시켜 보세요.",
  },
  {
    id: "weak-gluten",
    name: "반죽 개발 부족",
...
const ASSOCIATIONS: Association[] = [
  ...
  { causeId: "excess-salt", symptomId: "no-rise", weight: 2 },
  { causeId: "excess-salt", symptomId: "gummy", weight: 1 },
  { causeId: "excess-salt", symptomId: "pale", weight: 1 },
];
...
export const WHITE_LOAF: BreadKnowledge = {
  symptoms: SYMPTOMS,
  causes: CAUSES,
